      ...
      <div className="container mx-auto flex flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
            Hi, I'm Aditya. <br className="hidden lg:inline-block" />
            <div className="animate-typing overflow-hidden whitespace-nowrap lg:w-fit">
              This Ken is a Backend Developer. &nbsp;&nbsp;
            </div>
          </h1>
          <p className="mb-8 leading-relaxed text-base lg:text-lg">
        ...
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 content-center">
          <img
            width="300"
            height="300"
